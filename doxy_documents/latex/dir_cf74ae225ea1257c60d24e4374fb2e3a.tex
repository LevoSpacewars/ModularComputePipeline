\doxysection{/\+Users/nicholaspatapoff/\+Documents/\+Git\+Hub/\+Modular\+Compute\+Pipeline/subprojects/googletest-\/1.15.2/googletest Directory Reference}
\hypertarget{dir_cf74ae225ea1257c60d24e4374fb2e3a}{}\label{dir_cf74ae225ea1257c60d24e4374fb2e3a}\index{/Users/nicholaspatapoff/Documents/GitHub/ModularComputePipeline/subprojects/googletest-\/1.15.2/googletest Directory Reference@{/Users/nicholaspatapoff/Documents/GitHub/ModularComputePipeline/subprojects/googletest-\/1.15.2/googletest Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_bf160ddc3aab53e408cf0b475edf0656}{docs}}
\item 
directory \mbox{\hyperlink{dir_0b778b7c26d5c00c27a4383ef2d9efdb}{samples}}
\item 
directory \mbox{\hyperlink{dir_7d6af6f09184079aa165d621345fce59}{src}}
\item 
directory \mbox{\hyperlink{dir_f7fd9e433d83330b7b25763c30df3d1d}{test}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md398}{}\doxysubsubsubsection{\texorpdfstring{Setup}{Setup}}\label{README.md_autotoc_md398}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{README.md_autotoc_md399}{}\doxysubsubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{README.md_autotoc_md399}
...
CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{README.md_autotoc_md400}{}\doxysubsubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{README.md_autotoc_md400}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{README.md_autotoc_md401}{}\doxysubsubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{README.md_autotoc_md401}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{README.md_autotoc_md402}{}\doxysubsubsubsubsection{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{README.md_autotoc_md402}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{README.md_autotoc_md403}{}\doxysubsubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{README.md_autotoc_md403}
An environment that supports C++14 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 14)} command along with {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD\+\_\+\+REQUIRED ON)}. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the{\ttfamily -\/DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{README.md_autotoc_md404}{}\doxysubsubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{README.md_autotoc_md404}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{README.md_autotoc_md405}{}\doxysubsubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{README.md_autotoc_md405}
