...
\hypertarget{gtest-typed-test__test_8cc_source}{}\label{gtest-typed-test__test_8cc_source}\index{/Users/nicholaspatapoff/Documents/GitHub/ModularComputePipeline/subprojects/googletest-\/1.15.2/googletest/test/gtest-\/typed-\/test\_test.cc@{/Users/nicholaspatapoff/Documents/GitHub/ModularComputePipeline/subprojects/googletest-\/1.15.2/googletest/test/gtest-\/typed-\/test\_test.cc}}
...
\DoxyCodeLine{00047\ class\ CommonTest\ :\ public\ Test\ \{}
...
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \ \ CommonTest()\ :\ value\_(1)\ \{\}}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \ \ \string~CommonTest()\textcolor{keyword}{\ override\ }\{\ EXPECT\_EQ(3,\ value\_);\ \}}
\DoxyCodeLine{00069\ }
...
\DoxyCodeLine{00085\ T*\ CommonTest<T>::shared\_\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00087\ \textcolor{keyword}{using\ }testing::Types;}
\DoxyCodeLine{00088\ }
...
\DoxyCodeLine{00129\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test1}{TypedTest1}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00130\ }
...
\DoxyCodeLine{00137\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test2}{TypedTest2}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00138\ }
...
\DoxyCodeLine{00152\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classlibrary1_1_1_numeric_test}{NumericTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00153\ }
...
\DoxyCodeLine{00193\ \}}
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00195\ \textcolor{keyword}{using\ }testing::Types;}
...
\DoxyCodeLine{00199\ }
\DoxyCodeLine{00200\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test_suite_p_state_test}{TypedTestSuitePStateTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{}
...
\DoxyCodeLine{00223\ \}}
\DoxyCodeLine{00224\ }
\DoxyCodeLine{00225\ \textcolor{keyword}{using\ }TypedTestSuitePStateDeathTest\ =\ \mbox{\hyperlink{class_typed_test_suite_p_state_test}{TypedTestSuitePStateTest}};}
\DoxyCodeLine{00226\ }
\DoxyCodeLine{00227\ TEST\_F(TypedTestSuitePStateDeathTest,\ DetectsDuplicates)\ \{}
...
\DoxyCodeLine{00231\ \}}
\DoxyCodeLine{00232\ }
\DoxyCodeLine{00233\ TEST\_F(TypedTestSuitePStateDeathTest,\ DetectsExtraTest)\ \{}
...
\DoxyCodeLine{00237\ \}}
\DoxyCodeLine{00238\ }
\DoxyCodeLine{00239\ TEST\_F(TypedTestSuitePStateDeathTest,\ DetectsMissedTest)\ \{}
...
\DoxyCodeLine{00247\ TEST\_F(TypedTestSuitePStateDeathTest,\ DetectsTestAfterRegistration)\ \{}
...
\DoxyCodeLine{00259\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_derived_test}{DerivedTest}}\ :\ \textcolor{keyword}{public}\ CommonTest<T>\ \{\};}
\DoxyCodeLine{00260\ }
...
\DoxyCodeLine{00292\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_type_parametrized_test_with_names}{TypeParametrizedTestWithNames}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00293\ }
...
\DoxyCodeLine{00333\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test_p1}{TypedTestP1}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00334\ }
...
\DoxyCodeLine{00351\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test_p2}{TypedTestP2}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00352\ }
...
\DoxyCodeLine{00387\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classlibrary2_1_1_numeric_test}{NumericTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00388\ }
...
\DoxyCodeLine{00395\ \}}
\DoxyCodeLine{00396\ }
\DoxyCodeLine{00397\ REGISTER\_TYPED\_TEST\_SUITE\_P(\mbox{\hyperlink{classlibrary2_1_1_numeric_test}{NumericTest}},\ DefaultIsZero,\ ZeroIsLessThanOne);}
\DoxyCodeLine{00398\ \textcolor{keyword}{typedef}\ Types<int,\ double>\ NumericTypes;}
\DoxyCodeLine{00399\ INSTANTIATE\_TYPED\_TEST\_SUITE\_P(My,\ \mbox{\hyperlink{classlibrary2_1_1_numeric_test}{NumericTest}},\ NumericTypes);}
\DoxyCodeLine{00400\ }
...
\DoxyCodeLine{00406\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
...
\DoxyCodeLine{00410\ TYPED\_TEST\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test3)\ \{\ EXPECT\_STREQ(\textcolor{stringliteral}{"{}Test3"{}},\ GetTestName());\ \}}
\DoxyCodeLine{00411\ TYPED\_TEST\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test4)\ \{\ EXPECT\_STREQ(\textcolor{stringliteral}{"{}Test4"{}},\ GetTestName());\ \}}
\DoxyCodeLine{00412\ TYPED\_TEST\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test5)\ \{\ EXPECT\_STREQ(\textcolor{stringliteral}{"{}Test5"{}},\ GetTestName());\ \}}
\DoxyCodeLine{00413\ REGISTER\_TYPED\_TEST\_SUITE\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test1,\ Test2,\ Test3,\ Test4,}
